...
modified: 2026-08-21
definition: >-
  The blank period when a browser hides text entirely rather than show it in a
  fallback face while the web font loads.
aliases:
...
relations:
  contrastWith: [flash-of-inaccurate-color-theme, fout, foft, font-metric-override]
sources:
