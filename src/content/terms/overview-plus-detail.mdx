...
modified: 2026-08-21
definition: >-
  A layout that shows a compressed overview and a detailed view at the same time in separate
  regions, so the reader keeps their place while inspecting one part.
aliases:
  ...
  - name: minimap pane
    source: community
relations:
  contrastWith: [minimap, focus-plus-context]
sources:
