...
modified: 2026-08-26
definition: >-
  Colour made by adding light, where red, green and blue at full strength give white, which is
  why a screen is at its brightest when it is showing all three.
aliases:
  - name: light mixing
    source: community
  - name: emissive colour
    source: community
relations:
  contrastWith: [subtractive-color, srgb]
  seeAlso: [blend-mode]
implementations: []
sources:
