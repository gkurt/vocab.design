...
modified: 2026-08-21
definition: >-
  Using contrast, size, and position to pull attention to the option the business
  prefers while the other option is present but visually demoted.
aliases:
  ...
  - name: greyed-out decline
    source: community
relations:
  contrastWith: [trick-wording, confirmshaming, disguised-ad, fine-print]
