...
pass across it, and there would be nowhere left to drag to. Touch also puts the two holds back
to back, since the drag has to be started by a long press on the app before there is anything
in hand to hold over the folder.
