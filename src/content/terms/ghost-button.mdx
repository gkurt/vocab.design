...
status: published
definition: >-
  A button with no fill and often no border until you hover it, sitting at the
  bottom of the emphasis ladder above a plain link.
aliases:
  - name: text button
    source: material
  ...
  - name: borderless button
    source: community
relations:
  contrastWith: [link, button-versus-link]
  variantOf: [button]
implementations:
  - system: material
    name: Text button
