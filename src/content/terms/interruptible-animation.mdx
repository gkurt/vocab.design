...
modified: 2026-08-21
definition: >-
  Motion that can be caught, reversed, or redirected mid-flight from its current value,
  instead of finishing before it will accept a new input.
aliases:
  ...
  - name: velocity
    source: community
relations:
  contrastWith: [spring-animation, additive-animation, interactive-transition]
implementations:
  - system: hig
    name: Motion
