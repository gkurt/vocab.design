...
modified: 2026-08-21
definition: >-
  A gradient whose colours sweep around a centre point like a clock hand rather than along a
  line, the shape behind pie charts, colour wheels and progress rings.
aliases:
...
tags: [web-platform]
relations:
  contrastWith: [gradient, mesh-gradient]
implementations: []
sources:
