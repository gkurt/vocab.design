...
modified: 2026-08-21
definition: >-
  A slot on a watch face filled with one live figure from an app, sized to be read in the
  second a wrist is raised.
aliases:
  - name: accessory
    source: hig
  - name: watch face widget
    source: community
tags: [platform-registers, time]
relations:
  contrastWith: [widget, stat]
implementations:
  - system: hig
    name: Complications
