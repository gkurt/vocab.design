...
modified: 2026-08-28
definition: >-
  A solution reached for again and again for a familiar problem, which fails at the thing
  it was reached for and often leaves the situation worse than doing nothing.
aliases:
  - name: antipattern
    source: community
  - name: design anti-pattern
relations:
  contrastWith: [dark-pattern]
  seeAlso: [placeholder-as-label]
sources:
