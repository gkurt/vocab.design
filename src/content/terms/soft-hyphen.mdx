...
modified: 2026-08-21
definition: >-
  An invisible character placed inside a word that marks where a hyphen may
  appear if the word has to break, and stays hidden otherwise.
aliases:
  - name: shy
    source: html
...
relations:
  contrastWith: [zero-width-space, hyphenation]
sources:
