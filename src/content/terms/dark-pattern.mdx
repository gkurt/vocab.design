...
status: published
definition: >-
  An interface arranged to make the reader do something they did not intend and would
  not have chosen, by exploiting how attention and defaults work.
aliases:
...
Harry Brignull coined the phrase in 2010 and catalogued it at darkpatterns.org,
which now runs as deceptive.design under a name that survives translation and does
not lean on "dark" as a synonym for bad. The catalogue is the useful part: the
