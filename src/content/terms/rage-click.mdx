...
modified: 2026-08-21
definition: >-
  A burst of repeated clicks on one spot, the shape frustration takes when a control
  answers nothing, and the analytics signal that goes looking for it.
aliases:
  - name: rage clicking
    source: community
  - name: rage tap
...
tags: [errors, pointer]
relations:
  contrastWith: [ghost-click, dead-zone]
  seeAlso: [microinteraction, optimistic-ui]
sources:
