...
status: published
definition: >-
  Google's 2025 update to Material 3: springier motion, emphasized typography, updated
  dynamic colour themes, and responsive components that stretch to hug the display.
aliases:
  - name: M3 Expressive
    source: material
...
relations:
  contrastWith: [material-you]
  seeAlso: [motion-token]
implementations: []
sources:
