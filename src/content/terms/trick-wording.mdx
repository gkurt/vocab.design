...
modified: 2026-08-21
definition: >-
  Phrasing a choice so its plain reading is the opposite of its effect, typically through
  double negatives or a label that describes the wrong outcome.
aliases:
  - name: trick question
    source: community
  ...
  - name: confusing wording
    source: community
relations:
  contrastWith: [confirmshaming, misdirection]
