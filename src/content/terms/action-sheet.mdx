...
modified: 2026-08-21
definition: >-
  A modal list of choices that slides up from the bottom of a phone screen in
  response to something you just did, with cancel at the end.
aliases:
  - name: action sheets
    source: hig
  ...
  - name: option sheet
    source: community
tags: [menus, overlays, platform-registers, touch]
relations:
  contrastWith: [drawer, context-menu, bottom-sheet, share-sheet]
implementations:
  - system: hig
    name: Action sheets
