...
modified: 2026-08-21
definition: >-
  How thick a typeface's strokes are, named in steps from thin to black and
  numbered from 100 to 900 on the web.
aliases:
  - name: weight
  - name: boldness
  - name: wght axis
  ...
  - name: type weight
relations:
  contrastWith: [faux-bold, named-instance]
  seeAlso: [typographic-color, grade-axis]
sources:
