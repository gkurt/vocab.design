...
status: published
definition: >-
  The control in an assistant interface that picks which model answers, usually a menu
  carrying a short description of each option.
aliases:
  - name: model picker
    source: community
  - name: model switcher
...
relations:
  contrastWith: [select]
  seeAlso: [prompt-input, segmented-control]
implementations: []
sources:
