...
modified: 2026-08-21
definition: >-
  Acting on an object by handling the object itself, dragging, resizing, or typing
  into it, rather than describing the change in a separate control.
aliases:
...
relations:
  contrastWith: [inline-edit]
  seeAlso: [affordance, drag-and-drop]
implementations: []
sources:
