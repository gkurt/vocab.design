...
modified: 2026-08-21
definition: >-
  An element that breaks past the content column to span the whole viewport width
  while its neighbours stay constrained.
aliases:
  - name: full width
    source: community
  - name: bleed
  ...
  - name: alignfull
    source: wordpress
relations:
  contrastWith: [hero, breakout, container]
sources:
