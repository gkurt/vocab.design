...
modified: 2026-08-21
definition: >-
  The alternate pointer press, usually the right button or a two-finger tap, reserved for
  opening contextual actions rather than activating.
aliases:
  - name: right click
    source: community
  - name: context click
  ...
  - name: control-click
    source: hig
relations:
  contrastWith: [context-menu, double-click, middle-click, tap]
implementations: []
sources:
