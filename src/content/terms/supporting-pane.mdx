...
modified: 2026-08-21
definition: >-
  A secondary pane holding content that only makes sense next to the main pane, placed
  beside it on wide windows and below it or behind a control on narrow ones.
aliases:
  - name: secondary pane
    source: community
...
relations:
  contrastWith: [inspector, list-detail, pane]
implementations:
  - system: material
