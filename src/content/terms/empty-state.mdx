...
modified: 2026-08-26
definition: >-
  The screen a container shows when it holds nothing, naming the absence and
  offering the action that ends it.
aliases:
...
relations:
  contrastWith: [zero-state, skeleton-screen, no-results-state]
  seeAlso: [agenda-view]
implementations:
  - system: carbon
    name: Empty states
