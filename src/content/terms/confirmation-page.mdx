...
modified: 2026-08-21
definition: >-
  The screen that closes a transaction, stating plainly that it succeeded, giving a
  reference the reader can quote, and saying what happens next.
aliases:
  - name: success page
    source: community
  - name: thank you page
  ...
  - name: order confirmation
    source: community
tags: [commerce, content-design]
relations:
  contrastWith: [order-summary, check-answers]
implementations: []
sources:
