...
modified: 2026-08-26
definition: >-
  A table built for working with data rather than reading it: sortable columns,
  selectable rows, and controls that act on the rows you select.
aliases:
  - name: table
    source: aria-apg
  - name: index table
...
tags: [tables]
relations:
  contrastWith: [list, comparison-table, data-grid, treegrid, table-based-layout]
  seeAlso: [density, chart-description, table-header-association, description-list, zebra-striping]
implementations:
  - system: aria-apg
