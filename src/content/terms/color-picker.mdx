...
modified: 2026-08-21
definition: >-
  A control for choosing a colour, usually pairing a saturation and lightness
  field with a hue slider, an alpha slider and a text field for a value.
aliases:
  - name: color chooser
    source: community
  - name: color input
...
relations:
  contrastWith: [color-well, eyedropper]
  seeAlso: [swatch]
sources:
