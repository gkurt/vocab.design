...
modified: 2026-08-21
definition: >-
  The declaration that a page or element supports light or dark rendering, which also
...
relations:
  contrastWith: [color-theme, dark-mode, light-dark]
  seeAlso: [flash-of-inaccurate-color-theme]
implementations: []
sources:
