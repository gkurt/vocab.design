...
modified: 2026-08-21
definition: >-
  A photo grid that scales and trims images so every row lands on one shared height with flush left
  and right edges, unlike masonry's ragged columns.
aliases:
...
tags: [grids, media]
relations:
  contrastWith: [card-grid, grid-lanes, masonry]
  seeAlso: [object-fit, deconstructed-pancake]
sources:
