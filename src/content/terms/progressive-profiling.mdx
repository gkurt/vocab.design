...
modified: 2026-08-21
definition: >-
  Collecting profile details a few at a time across separate visits, instead of demanding
  the whole record in one long form at registration.
aliases:
  ...
  - name: profile completeness
    source: community
tags: [auth, forms, onboarding]
relations:
  contrastWith: [gradual-engagement]
  seeAlso: [microsurvey]
implementations: []
sources:
