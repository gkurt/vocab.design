...
status: published
definition: >-
  Moving focus by direction rather than by sequence, so arrow keys, a D-pad, or a TV remote jump
  to the nearest control up, down, left, or right.
aliases:
  ...
  - name: 10-foot UI navigation
    source: community
tags: [keyboard, navigation, platform-registers]
relations:
  contrastWith: [roving-tabindex, switch-access]
  seeAlso: [ten-foot-ui, focus-order]
implementations: []
sources:
