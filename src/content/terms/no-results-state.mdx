...
modified: 2026-08-28
definition: >-
  What a search or filtered list shows when nothing matched, naming the query,
  explaining why, and offering a way to loosen the constraints.
aliases:
  - name: zero results
    source: community
  - name: no matches
  ...
  - name: null state
    source: community
tags: [content-design, errors, search]
relations:
  contrastWith: [empty-state, did-you-mean, error-page]
sources:
