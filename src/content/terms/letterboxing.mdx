...
status: published
definition: >-
  Filling the mismatch between content shape and frame shape with bars: above and below for
  letterbox, at the sides for pillarbox.
aliases:
  - name: pillarboxing
    source: community
  - name: windowboxing
...
tags: [media]
relations:
  contrastWith: [object-fit]
  seeAlso: [overscan-safe-area]
implementations: []
sources:
  - title: "Pillarbox"
