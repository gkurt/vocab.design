...
modified: 2026-08-21
definition: >-
  How a synthetic voice says a word, and the hints an author can give when the default reading
  turns a product name, a units string, or a homograph into nonsense.
aliases:
...
relations:
  contrastWith: [ruby-annotation, abbreviation]
  seeAlso: [screen-reader]
implementations: []
sources:
