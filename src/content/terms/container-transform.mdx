...
modified: 2026-08-21
definition: >-
  Material's transition in which a container grows or shrinks into another one, its contents
  crossfading inside, so a card visibly becomes the screen it opened.
aliases:
...
tags: [depth]
relations:
  contrastWith: [shared-axis, cloning, origin-aware-animation]
implementations:
  - system: material
    name: Container transform
