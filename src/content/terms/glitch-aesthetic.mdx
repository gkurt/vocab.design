...
modified: 2026-08-21
definition: >-
  A look that fakes signal failure with colour channel offset, torn scan bands, and
  jitter, used for emphasis or as a whole visual identity.
aliases:
  - name: glitch art
  - name: RGB split
    source: community
  ...
  - name: datamosh
relations:
  contrastWith: [vhs-aesthetic, scanlines]
  seeAlso: [dithering]
implementations: []
sources:
