...
modified: 2026-08-21
definition: >-
  A click that both focuses an inactive surface and reaches the control underneath, instead of
  being spent activating the window first.
aliases:
...
relations:
  contrastWith: [nested-interactive, focus-follows-mouse]
implementations: []
sources:
