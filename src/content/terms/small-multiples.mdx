...
modified: 2026-08-21
definition: >-
  The same small chart repeated in a grid, once per category, so comparison happens by eye
  movement instead of overplotting.
aliases:
  - name: trellis chart
  - name: panel chart
  - name: grid of charts
  - name: lattice chart
tags: [dataviz, grids, perception]
relations:
  seeAlso: [brushing, dual-axis]
implementations: []
sources:
