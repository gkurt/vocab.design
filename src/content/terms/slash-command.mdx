...
modified: 2026-08-21
definition: >-
  Typing a forward slash in a composer to open a menu of actions, where choosing one runs
  it rather than inserting the words into the message.
aliases:
  - name: slash menu
    source: community
  ...
  - name: slash commands
    source: merged-candidate
tags: [ai, menus, messaging, text-editing]
relations:
  contrastWith: [command-palette, mention-autocomplete]
implementations: []
sources:
