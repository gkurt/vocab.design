...
modified: 2026-08-21
definition: >-
  Text set entirely in capitals, which reads slower than mixed case because the
  word's outline shape disappears.
aliases:
  - name: uppercase
  - name: caps
...
relations:
  contrastWith: [small-caps, title-case, sentence-case]
  seeAlso: [letterpress-text]
sources:
