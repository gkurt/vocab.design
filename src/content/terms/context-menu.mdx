...
modified: 2026-08-21
definition: >-
  A menu of actions for one specific object, opened on that object by right click,
  long press, or the context menu key.
aliases:
  ...
  - name: shortcut menu
relations:
  contrastWith: [kebab-menu, dropdown, action-sheet, swipe-actions, secondary-click, radial-menu]
  seeAlso: [action-list, share-sheet, bubble-toolbar]
implementations:
  - system: radix
    name: Context Menu
