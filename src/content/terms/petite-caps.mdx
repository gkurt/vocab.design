...
specimen above makes both requests of one face and compares what came back, which
is the check worth running against any family you are considering: if the petite
run is the same drawing as the small-caps run, there was no `pcap` set to answer
with.
