...
modified: 2026-08-21
definition: >-
  A command issued by the shape of a pointer stroke, usually with a button held, so a movement
  stands in for a menu choice.
aliases:
  - name: rocker gesture
    source: community
...
tags: [pointer]
relations:
  contrastWith: [marking-menu]
  seeAlso: [pointer-gestures]
implementations: []
sources:
