...
modified: 2026-08-21
definition: >-
  Shipping only the characters a page actually needs, cutting the font file down
  and letting the browser fetch ranges on demand.
aliases:
  - name: subsetting
  - name: unicode-range
    source: css
...
tags: [fonts, perceived-performance, web-platform]
relations:
  seeAlso: [web-font, icon-font]
sources:
