...
modified: 2026-08-21
definition: >-
  The motion an element plays as it arrives, running from a starting style that only
  exists before the element was ever rendered.
aliases:
...
tags: [web-platform]
relations:
  contrastWith: [exit-animation, origin-aware-animation, pop-in]
implementations: []
sources:
