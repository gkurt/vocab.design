...
modified: 2026-08-26
definition: >-
  The line an inbox prints under a subject, written as hidden text at the top of the mail
  so the client shows those words instead of scraping whatever body copy comes first.
aliases:
  - name: preheader
    source: litmus
  - name: preheader text
...
relations:
  contrastWith: [subject-line, sender-name]
  seeAlso: [truncation]
implementations: []
sources:
