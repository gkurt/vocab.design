...
status: published
definition: >-
  A thin line separating groups of content, decorative when the grouping is
  already clear and semantic when it is the only cue.
aliases:
  - name: separator
    source: aria-apg
  - name: rule
  ...
  - name: hr
relations:
  contrastWith: [outline-color, splitter, zebra-striping, keyline]
implementations:
  - system: fluent
    name: Divider
