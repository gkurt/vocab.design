...
status: published
definition: >-
  The greys an interface is mostly made of, ramped from page background to body text,
  which carry the structure while the accent carries the attention.
aliases:
  - name: greyscale
    source: community
  - name: grayscale
  ...
  - name: slate scale
    source: radix
relations:
  contrastWith: [tinted-neutral, color-ramp]
implementations: []
sources:
  - title: "Carbon: color"
