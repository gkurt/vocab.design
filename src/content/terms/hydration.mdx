...
modified: 2026-08-25
definition: >-
  The pass where script attaches behaviour to server-rendered HTML, turning a page that
  is already painted and readable into one that answers input.
aliases:
  - name: rehydration
    source: community
...
relations:
  contrastWith: [skeleton-screen, ghost-click]
  seeAlso: [flash-of-inaccurate-color-theme, speculative-loading]
implementations: []
sources:
