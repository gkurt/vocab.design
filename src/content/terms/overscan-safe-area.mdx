...
modified: 2026-08-26
definition: >-
  The inset a television layout keeps clear of the screen edge, about five percent, because sets
  crop the outer frame and anything near it disappears.
aliases:
...
relations:
  contrastWith: [display-cutout]
  seeAlso: [ten-foot-ui, letterboxing, top-shelf]
implementations: []
sources:
