...
modified: 2026-08-21
definition: >-
  A spacing convention where every size and gap is a multiple of eight, so values stay
  whole numbers at every common screen density.
aliases:
  - name: 8pt grid
    source: community
  - name: 8 point grid
  ...
  - name: mini unit
    source: carbon
tags: [grids, spacing, tokens]
relations:
  contrastWith: [spacing-scale, baseline-grid]
demo: inline
