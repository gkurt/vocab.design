...
status: published
definition: >-
  A statement of the gap between what a person can do and what a design demands, the WCAG 3 draft's
  way of naming a barrier without sorting people into disability categories.
aliases:
  ...
  - name: user need
    source: w3c
relations:
  contrastWith: [situational-disability, pour]
  seeAlso: [curb-cut-effect]
implementations: []
sources:
