...
modified: 2026-08-25
definition: >-
  One command word or icon wired to different outcomes depending on where it sits, so having used it
  once teaches the reader nothing about the next one.
aliases:
  ...
  - name: overloaded button
    source: community
tags: [menus, perception]
relations:
  contrastWith: [consistent-identification, split-button]
  variantOf: []
  partOf: []
  seeAlso: [signifier]
implementations: []
