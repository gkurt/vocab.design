...
modified: 2026-08-21
definition: >-
  How wide a chart is for its height, which sets the slopes of its lines; banking to 45 degrees
  keeps rates of change readable.
aliases:
  - name: banking to 45 degrees
  - name: banking
tags: [dataviz]
relations:
  seeAlso: [chart, aspect-ratio-box]
implementations: []
sources:
