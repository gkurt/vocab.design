...
modified: 2026-08-21
definition: >-
  Whether a long unbroken string is allowed to split mid-word rather than overflow its
  container, and where that split may happen.
aliases:
  - name: overflow-wrap
    source: css
  - name: word-wrap
...
relations:
  contrastWith: [hyphenation, truncation, zero-width-space]
sources:
