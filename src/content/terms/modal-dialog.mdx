...
aliases:
  - name: modal
relations:
  contrastWith: [popover, drawer, alert-dialog, quick-view, bottom-sheet]
  seeAlso: [focus-trap, inert, initial-focus, scrim, lightbox, top-layer, interstitial, invoker-command]
implementations:
  - system: aria-apg
    name: Dialog (Modal)
