...
modified: 2026-08-21
definition: >-
  A technique that measures an element's first and last positions, inverts the
  difference with a transform, then plays it off, so layout changes animate cheaply.
aliases:
...
tags: [web-platform]
relations:
  contrastWith: [height-animation, card-flip]
  seeAlso: [layout-thrashing]
implementations: []
sources:
