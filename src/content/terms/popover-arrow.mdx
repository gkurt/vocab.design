...
modified: 2026-08-21
definition: >-
  The small triangle joining a popover or tooltip to the thing it belongs to, which
  flips and slides as the popover repositions.
aliases:
  - name: tooltip arrow
    source: radix
  - name: beak
  ...
  - name: pointer
    source: community
relations:
  contrastWith: [chevron]
  partOf: [popover, tooltip]
