...
modified: 2026-08-21
definition: >-
  A small always on top window that keeps video or navigation visible in a corner while the
  reader works in another app or scrolls another page.
aliases:
  - name: PiP
    source: android
  - name: mini player
  ...
  - name: floating player
    source: community
tags: [media, overlays, windowing]
relations:
  contrastWith: [video-player]
  seeAlso: [multi-window-mode]
sources:
