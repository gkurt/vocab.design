...
modified: 2026-08-21
definition: >-
  An entrance that scales slightly past full size before settling, so the element arrives with
  a small snap instead of simply being there.
aliases:
  - name: pop
    source: community
  - name: spring in
  ...
  - name: scale in with overshoot
    source: community
relations:
  contrastWith: [entrance-animation, bounce-animation]
  seeAlso: [squash-and-stretch]
implementations: []
sources:
