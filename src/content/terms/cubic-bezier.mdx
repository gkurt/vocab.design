...
modified: 2026-08-21
definition: >-
  The four-control-point curve that describes how a value moves between its start
  and end, the default way CSS spells an easing.
aliases:
  - name: bezier curve easing
  - name: easing curve
tags: [web-platform]
relations:
  contrastWith: [linear-easing, easing]
implementations: []
sources:
