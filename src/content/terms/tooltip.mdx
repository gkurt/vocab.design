...
tags: [overlays, pointer]
relations:
  contrastWith: [popover, hover-card, toggletip, accessible-description, hoverable-dismissible-persistent]
  seeAlso: [hover-intent, coach-mark, interest-invoker]
implementations:
  - system: aria-apg
    name: Tooltip
