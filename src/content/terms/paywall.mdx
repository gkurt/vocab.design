...
modified: 2026-08-21
definition: >-
  A barrier that stops access to content or a feature until the reader pays, placed
  either before anything is shown or partway into the content.
aliases:
  - name: hard paywall
    source: community
  - name: content gate
...
tags: [commerce]
relations:
  contrastWith: [metered-paywall, feature-gate]
implementations: []
sources:
