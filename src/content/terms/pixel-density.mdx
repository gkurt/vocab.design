...
modified: 2026-08-21
definition: >-
  How many physical pixels a display packs into an inch, and the reason a CSS pixel is a
  unit of measure rather than a dot on the screen.
aliases:
  - name: DPI
  - name: PPI
  - name: retina
...
relations:
  contrastWith: [density-independent-pixel]
  seeAlso: [signed-distance-field, font-hinting, font-smoothing]
implementations: []
sources:
