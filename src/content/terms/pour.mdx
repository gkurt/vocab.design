...
status: published
definition: >-
  The four principles WCAG is built on, perceivable, operable, understandable, and robust, used as a
  shorthand for sorting an accessibility problem into a bucket.
aliases:
  ...
  - name: four principles
    source: wcag
relations:
  contrastWith: [functional-need, conformance-level]
implementations: []
sources:
