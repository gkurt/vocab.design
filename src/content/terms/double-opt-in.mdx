...
modified: 2026-08-26
definition: >-
  Asking a new subscriber to confirm from the address they typed, so a list holds only
  addresses whose owner agreed and a typo never becomes a stranger's mail.
aliases:
  ...
  - name: subscription confirmation
    source: community
relations:
  contrastWith: [magic-link]
  seeAlso: [unsubscribe-link, transactional-email]
implementations: []
sources:
