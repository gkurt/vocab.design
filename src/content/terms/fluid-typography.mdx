...
modified: 2026-08-26
definition: >-
  Type sizes that scale continuously with the viewport between a minimum and a
  maximum, rather than jumping at breakpoints.
aliases:
  ...
  - name: fluid heading styles
    source: carbon
tags: [screen-size, spacing]
relations:
  contrastWith: [dynamic-type, modular-scale]
