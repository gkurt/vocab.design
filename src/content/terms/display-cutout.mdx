...
modified: 2026-08-21
definition: >-
  The camera housing that intrudes into the screen rectangle, which a layout has to route
  content around rather than under.
aliases:
  - name: notch
    source: community
  - name: dynamic island
...
relations:
  contrastWith: [overscan-safe-area, safe-area]
implementations: []
sources:
