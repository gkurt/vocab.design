...
modified: 2026-08-21
definition: >-
  The ordered list of typefaces a rule names, each tried in turn until one is
  available, ending in a generic family.
aliases:
...
relations:
  contrastWith: [fallback-font, web-font, system-font]
sources:
