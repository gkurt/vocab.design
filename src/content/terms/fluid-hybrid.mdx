...
modified: 2026-08-26
definition: >-
  A mail layout that reflows with no media query at all: percentage widths held in by max-width,
  with fixed-width ghost tables that only Outlook can see.
aliases:
  ...
  - name: fluid email
    source: community
tags: [email, screen-size]
relations:
  contrastWith: [switcher]
