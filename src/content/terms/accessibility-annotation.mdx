...
modified: 2026-08-28
definition: >-
  Notes attached to a design file that spell out the things a mockup cannot show: heading levels,
  focus order, names, roles, live regions, and alt text.
aliases:
...
relations:
  ...
  seeAlso: [accessibility-tree, focus-order, mockup]
implementations:
  - system: fluent
