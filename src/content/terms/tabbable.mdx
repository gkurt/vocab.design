...
modified: 2026-08-21
definition: >-
  Reachable by the Tab key, as opposed to merely focusable: an element with tabindex of -1 can
  take focus from script but never from Tab.
aliases:
...
tags: [keyboard]
relations:
  contrastWith: [tab-stop, positive-tabindex, focusable-disabled]
  seeAlso: [focusable-scroll-region]
implementations: []
sources:
  - title: "MDN: tabindex"
