...
modified: 2026-08-21
definition: >-
  A control that leaves the current page immediately for an unrelated site and tries to clear
  it from history, for readers who may be watched.
aliases:
  - name: exit this page
    source: govuk
  - name: quick exit
