...
modified: 2026-08-21
definition: >-
  A nested grid that borrows its parent's tracks instead of defining its own, so contents of
  separate children still line up with each other.
aliases:
...
relations:
  contrastWith: [baseline-grid, named-grid-areas]
sources:
  - title: "Subgrid, MDN"
