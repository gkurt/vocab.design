...
modified: 2026-08-21
definition: >-
  Nudging an element off its measured position so it looks aligned, correcting for shapes
  whose bounding box lies about their visual centre.
aliases:
...
relations:
  contrastWith: [keyline, text-box-trim]
  seeAlso: [visual-balance, hanging-punctuation]
implementations: []
sources:
