...
modified: 2026-08-21
definition: >-
  A bar of three to five top level destinations pinned to the bottom edge of a
  phone screen, with the current destination always marked.
aliases:
  - name: tab bar
    source: hig
  - name: bottom tabs
...
relations:
  contrastWith: [navigation-bar, dock, navigation-rail]
implementations:
  - system: material
    name: Navigation bar
