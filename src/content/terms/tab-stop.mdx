...
modified: 2026-08-21
definition: >-
  One position in the tab sequence: a place the Tab key can reach, counted once even
  when the widget it belongs to holds many focusable parts.
aliases:
...
tags: [keyboard]
relations:
  contrastWith: [roving-tabindex, tabbable]
implementations: []
sources:
