...
status: published
definition: >-
  A shortcut whose keys are held down together like a chord, in contrast to one typed as a
  sequence of separate presses.
aliases:
  - name: key chord
    source: community
  - name: chording
  ...
  - name: combo key
    source: community
relations:
  contrastWith: [key-sequence, modifier-key, keyboard-shortcut]
sources:
