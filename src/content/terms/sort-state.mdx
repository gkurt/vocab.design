...
modified: 2026-08-21
definition: >-
  The announced direction of the one column a table is currently sorted by, carried on
  that column header alone rather than on every sortable header.
aliases:
  - name: aria-sort
    source: aria
  - name: sort direction
  ...
  - name: sortable column indicator
    source: community
tags: [assistive-tech, tables]
relations:
  contrastWith: [sort-indicator]
  seeAlso: [table-header-association]
sources:
  - title: 'MDN: aria-sort'
