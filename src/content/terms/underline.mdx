...
status: published
definition: >-
  A rule drawn under text, on the web the default marker for a link, ideally set
  to skip the descenders it would otherwise cross.
aliases:
...
tags: [a11y]
relations:
  contrastWith: [link, strikethrough]
  seeAlso: [italic]
sources:
