...
modified: 2026-08-21
definition: >-
  The invisible line that most letters sit on, and the line every other vertical
  type metric is measured from.
aliases:
  - name: alphabetic baseline
    source: css
  - name: text baseline
relations:
  contrastWith: [cap-height, half-leading, descender]
sources:
