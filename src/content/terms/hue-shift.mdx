...
modified: 2026-08-21
definition: >-
  Rotating hue deliberately along a ramp, warmer at the light end and cooler at the dark
  end, so a scale looks alive instead of like one colour fading out.
aliases:
  - name: hue torsion
    source: community
  - name: hue rotation
...
relations:
  contrastWith: [color-interpolation, color-temperature]
  seeAlso: [color-ramp]
implementations: []
sources:
