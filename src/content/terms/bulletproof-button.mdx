...
modified: 2026-08-26
definition: >-
  A mail button built to survive a renderer that drops CSS: the fill carried by a cell or box
  behind the link rather than by a background the client can refuse.
aliases:
  ...
  - name: email button
    source: community
relations:
  contrastWith: [button-versus-link, touch-target]
  seeAlso: [table-based-layout, fallback-font, dark-mode-email, styled-alt-text]
sources:
