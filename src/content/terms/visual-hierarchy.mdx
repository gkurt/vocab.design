...
modified: 2026-08-21
definition: >-
  The ordering of elements by visual weight, size, contrast, position and spacing, so a
  reader learns what matters most without being told.
aliases:
  - name: hierarchy
    source: community
  ...
  - name: visual order
    source: community
relations:
  contrastWith: [typographic-hierarchy, focal-point]
  seeAlso: [visual-balance, signifier, gutenberg-diagram]
implementations: []
sources: []
demo: inline
