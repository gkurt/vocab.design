...
modified: 2026-08-21
definition: >-
  The loose everyday word for any panel that opens downward from a trigger, whatever
  the panel holds and whatever the trigger does with it.
aliases:
  - name: drop-down
  - name: dropdown menu
tags: [forms, menus, overlays]
relations:
  contrastWith: [select, combobox, menu-button, context-menu]
implementations:
  - system: radix
    name: Dropdown Menu
