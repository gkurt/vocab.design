...
modified: 2026-08-21
definition: >-
  A strip pinned to the top of a mobile web page urging the reader to open or install the
  native app instead, with an install or open action.
aliases:
  ...
  - name: install prompt
    source: community
tags: [onboarding, platform-registers]
relations:
  contrastWith: [interstitial, banner]
  seeAlso: [qr-code]
implementations: []
sources:
