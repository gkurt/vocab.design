...
modified: 2026-08-21
definition: >-
  How much a screen reader says about each thing it reaches, a user setting that decides
  whether your carefully written description is heard at all.
aliases:
  ...
  - name: verbosity setting
    source: community
relations:
  contrastWith: [politeness-level]
  seeAlso: [screen-reader, role-description, braille-display]
implementations: []
sources:
