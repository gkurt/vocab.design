...
modified: 2026-08-21
definition: >-
  The height of a capital letter measured from the baseline, and the edge
  designers usually mean when they say text should line up flush.
aliases:
  - name: capital height
  - name: cap-height baseline
    source: css
relations:
  contrastWith: [ascender, baseline, x-height]
  seeAlso: [overshoot]
sources:
