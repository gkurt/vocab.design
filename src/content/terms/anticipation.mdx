...
modified: 2026-08-21
definition: >-
  A small move in the opposite direction just before the main one, borrowed from
  character animation to telegraph what is about to happen.
aliases:
  - name: wind-up
    source: community
  - name: pre-move
...
tags: [perception]
relations:
  contrastWith: [overshoot, follow-through]
