...
modified: 2026-08-21
definition: >-
  The rule against asking for the same information twice in one process, unless it is re-entered
  for a real reason such as confirmation.
aliases:
...
tags: [forms]
relations:
  contrastWith: [smart-defaults, input-purpose]
implementations: []
sources:
