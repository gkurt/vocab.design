...
status: published
definition: >-
  Switching between two views of the same content, a zoomed out view of group headings and a zoomed
  in view of individual items, instead of scaling pixels.
aliases:
  - name: SemanticZoom
    source: fluent
...
relations:
  ...
  seeAlso: [pinch-to-zoom, zoom-transition, infinite-canvas]
implementations:
  - system: fluent
    name: Semantic zoom
