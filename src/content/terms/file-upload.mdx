...
status: published
definition: >-
  A control that takes files, by opening the system picker from a button or by
  accepting a drop into a marked area.
aliases:
  - name: file input
    source: cloudscape
  - name: file picker
...
tags: [forms]
relations:
  contrastWith: [drop-zone, file-attachment, image-well]
sources:
