...
modified: 2026-08-21
definition: >-
  A transition whose progress is held by an ongoing gesture, so the reader can drag it partway,
  hesitate, and either complete it or send it back.
aliases:
...
tags: [dragging, touch]
relations:
  contrastWith: [interruptible-animation, predictive-back]
  seeAlso: [swipe-to-dismiss]
implementations:
  - system: hig
    name: Motion
