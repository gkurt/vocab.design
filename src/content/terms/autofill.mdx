...
modified: 2026-08-25
definition: >-
  The browser filling a form from values it has already saved, on its own or from a dropdown of the
  reader's own profile, so a field arrives answered.
aliases:
...
tags: []
relations:
  contrastWith: [address-autocomplete, inline-autocomplete]
  variantOf: []
  partOf: []
  seeAlso: [input-purpose, redundant-entry]
implementations: []
sources:
  - title: "MDN: :autofill"
