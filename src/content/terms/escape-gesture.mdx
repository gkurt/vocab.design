...
modified: 2026-08-21
definition: >-
  The screen reader equivalent of the Escape key, a two finger scrub that dismisses a sheet
  or steps back a level.
aliases:
...
relations:
  contrastWith: [light-dismiss, explore-by-touch, magic-tap]
  seeAlso: [multi-touch]
sources:
