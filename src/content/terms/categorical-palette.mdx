...
modified: 2026-08-26
definition: >-
  A data palette of distinct hues at roughly equal visual weight, used for groups that have
  no order so no colour reads as larger than another.
aliases:
...
relations:
  contrastWith: [sequential-palette, diverging-palette, color-coding]
  seeAlso: [color-vision-deficiency]
implementations: []
sources:
