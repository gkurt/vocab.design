...
modified: 2026-08-21
definition: >-
  Turning a free trial into a paid subscription automatically, with the card taken up
  front and no reminder before the first real charge.
aliases:
  ...
  - name: free trial trap
    source: community
tags: [commerce, consent]
relations:
  contrastWith: [roach-motel]
