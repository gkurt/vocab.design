...
modified: 2026-08-21
definition: >-
  An interface drawn on a visible pixel grid, with bitmap type, hard aliased edges, and
  icons kept at their original low resolution.
aliases:
  - name: 8-bit UI
    source: community
  - name: bitmap UI
  ...
  - name: pixel art
    source: uistyleguide
tags: [icons, illustration, retro]
relations:
  contrastWith: [low-poly, scanlines]
  seeAlso: [retro-web-design, stepped-animation]
implementations: []
sources:
