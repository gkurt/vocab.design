...
modified: 2026-08-26
definition: >-
  A wash of the primary colour blended into a surface in proportion to its elevation, so height
  reads as a colour shift rather than only as a shadow.
aliases:
  - name: surfaceTint
    source: material
...
tags: [theming]
relations:
  contrastWith: [elevation-overlay, state-layer, container-color, elevation]
implementations:
  - system: material
    name: Surface tint
