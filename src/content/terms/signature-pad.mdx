...
modified: 2026-08-21
definition: >-
  A drawing area that captures a handwritten signature by pointer or touch, with a clear
  control and a baseline to sign on.
aliases:
  ...
  - name: sign here box
    source: community
tags: [forms, pointer, touch]
relations:
  contrastWith: [image-well]
  seeAlso: [pressure-sensitivity]
implementations: []
sources:
