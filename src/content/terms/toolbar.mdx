...
status: published
definition: >-
  A grouped row of controls acting on the current view, sharing one tab stop and
  moving focus between its items with arrow keys.
aliases:
  - name: tool bar
    source: community
  - name: action bar
  ...
  - name: command bar
    source: fluent
relations:
  contrastWith: [navigation-bar, button-group, menu-bar, ribbon, rich-text-toolbar, utility-bar, overflow-menu, app-bar]
  seeAlso: [title-bar]
implementations:
  - system: aria-apg
    name: Toolbar
