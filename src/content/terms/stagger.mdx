...
One animation, offset. Six rows fading in together read as a screen redrawing;
the same six rows offset by a tenth of a second each read as a list being dealt
out, and the eye follows the order you intended.
