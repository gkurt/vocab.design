...
status: published
definition: >-
  A note placed in the outer margin beside the line it belongs to, rather than collected at the
  foot of the page.
aliases:
  - name: margin note
    source: community
...
tags: [editorial]
relations:
  contrastWith: [sticky-sidebar]
  seeAlso: [superscript, breakout, pull-quote, blockquote]
implementations: []
sources: []
demo: inline
