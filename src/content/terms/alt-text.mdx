...
tags: [assistive-tech, content-design, media, wcag]
relations:
  contrastWith: [accessible-name, visually-hidden, decorative-image, chart-description, images-of-text, long-description, styled-alt-text]
  seeAlso: [image]
implementations:
  - system: fluent
