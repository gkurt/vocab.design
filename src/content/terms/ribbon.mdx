...
modified: 2026-08-21
definition: >-
  A tall tabbed toolbar that replaces menus, grouping commands into labelled sections with the
  important ones drawn larger.
aliases:
  - name: ribbon bar
    source: community
  - name: office ribbon
...
relations:
  contrastWith: [toolbar, menu-bar, rich-text-toolbar]
implementations: []
sources:
