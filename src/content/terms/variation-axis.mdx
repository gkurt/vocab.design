...
status: published
definition: >-
  One dimension a variable font can move along, named by a four-letter tag:
  lowercase for the five registered axes, uppercase for custom ones.
aliases:
  - name: font axis
  - name: design axis
  ...
  - name: wght wdth slnt ital opsz
    source: opentype
relations:
  contrastWith: [named-instance, grade-axis, optical-size, variable-font]
sources:
