...
modified: 2026-08-21
definition: >-
  An embedded picture, sized and cropped by the layout around it, carrying the
  alternative text that stands in when it cannot be seen.
aliases:
  - name: picture
...
tags: [media]
relations:
  contrastWith: [figure, thumbnail]
  seeAlso: [alt-text, decorative-image]
implementations: []
sources:
