...
modified: 2026-08-21
definition: >-
  Rotating a card in perspective toward the pointer so it appears to tip in three
  dimensions, often with a moving highlight to sell the depth.
aliases:
  - name: tilt card
    source: community
  - name: 3D hover tilt
...
tags: [depth, pointer]
relations:
  contrastWith: [spotlight-hover]
  seeAlso: [parallax, hover-lift]
implementations: []
sources:
