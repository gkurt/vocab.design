...
modified: 2026-08-28
definition: >-
  A screen shown as it will look rather than as it will work: colour, type and real copy
  all settled, and nothing in it clickable.
aliases:
  - name: mock-up
    source: community
  - name: mock UI
  ...
  - name: visual comp
    source: community
relations:
  contrastWith: [wireframe, prototype]
  seeAlso: [accessibility-annotation]
implementations: []
sources:
