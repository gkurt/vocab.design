...
modified: 2026-08-26
definition: >-
  The small fixed set of colours a product reserves for outcome, typically success, warning,
  danger and info, so meaning is consistent wherever it appears.
aliases:
  ...
  - name: state colors
    source: community
tags: [errors, theming, tokens]
relations:
  contrastWith: [accent-color, brand-color, color-coding]
implementations:
  - system: material
    name: Error
