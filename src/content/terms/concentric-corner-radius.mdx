...
modified: 2026-08-26
definition: >-
  Sizing a nested shape's corners so its curve shares a centre with the one outside it,
  the inner radius being the outer radius less the padding between them.
aliases:
  ...
  - name: nested radius
relations:
  seeAlso: [corner-radius, spacing-scale]
implementations: []
sources:
