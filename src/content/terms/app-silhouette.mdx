...
status: published
definition: >-
  The recognisable outline of an app's chrome, which bars and panes it has and where they sit, used
  to classify one app's layout against another's.
aliases:
  - name: silhouette
    source: fluent
