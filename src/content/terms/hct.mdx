...
modified: 2026-08-21
definition: >-
  Material's colour space of hue, chroma and tone, which borrows hue and chroma from CAM16 and
  lightness from CIELAB so tone alone predicts contrast.
aliases:
  ...
  - name: material-color-utilities
    source: material
tags: [perception, theming, tokens]
relations:
  contrastWith: [oklch, seed-color]
  seeAlso: [material-you, color-ramp]
implementations:
  - system: material
    name: HCT
