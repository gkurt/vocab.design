...
modified: 2026-08-21
definition: >-
  The nested outline formed by heading levels, navigated directly by assistive
  technology and broken by skipping a level or picking a level for its size.
aliases:
  - name: heading levels
    source: community
...
relations:
  contrastWith: [type-scale, landmark, heading, page-title]
  seeAlso: [semantic-html, rotor, layer-cake-pattern, table-of-contents]
implementations:
  - system: polaris
    name: Heading hierarchy
