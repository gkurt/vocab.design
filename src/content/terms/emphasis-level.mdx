...
modified: 2026-08-21
definition: >-
  A three-rung text hierarchy, high, medium and disabled, ranked by stepping the opacity of
  one foreground colour instead of naming a separate colour for each rung.
aliases:
  - name: high emphasis
    source: material
