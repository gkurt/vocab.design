...
modified: 2026-08-21
definition: >-
  Reaching for the element that already means what you mean, so name, role,
  keyboard behaviour, and platform conventions arrive for free instead of being
  rebuilt.
aliases:
  ...
  - name: divitis
    source: community
tags: [assistive-tech, web-platform]
relations:
  contrastWith: [first-rule-of-aria, name-role-value]
  seeAlso: [heading-hierarchy, accessibility-trait, accessibility-tree, reader-mode]
implementations:
  - system: polaris
