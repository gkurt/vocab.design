...
modified: 2026-08-21
definition: >-
  Reading a geometric value after writing to the DOM in the same frame, forcing the browser to
  lay out synchronously over and over and stalling the animation that caused it.
aliases:
  ...
  - name: read-write interleaving
    source: community
tags: [devtools, errors, perceived-performance]
relations:
  contrastWith: [compositor-animation, jank]
  seeAlso: [flip-animation]
implementations: []
sources:
