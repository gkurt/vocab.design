...
status: published
definition: >-
  Narrowing results by ticking values from several independent attribute groups,
  with counts showing how many results each value would leave.
aliases:
...
tags: [search]
relations:
  contrastWith: [search-field, faceted-filter, applied-filters]
implementations: []
sources:
