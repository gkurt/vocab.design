...
modified: 2026-08-26
definition: >-
  A reverse chronological list of things that happened, each entry naming an actor,
  a verb, and an object, grouped when many are alike.
aliases:
...
tags: [messaging]
relations:
  contrastWith: [timeline, notification-digest, agenda-view]
