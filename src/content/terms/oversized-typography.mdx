...
modified: 2026-08-26
definition: >-
  Type set far past reading size so the words carry the layout, the headline doing the work a
  photograph would otherwise be hired for.
aliases:
  - name: big type
    source: community
  - name: huge type
...
relations:
  contrastWith: [typographic-hierarchy]
  seeAlso: [fluid-typography, optical-size, swiss-style]
implementations: []
sources:
