...
modified: 2026-08-21
definition: >-
  Content that keeps moving after the finger lifts, decelerating as though it had mass,
  so one flick can travel a long way.
aliases:
...
tags: [scroll, touch]
relations:
  contrastWith: [overscroll, smooth-scrolling, fling]
  seeAlso: [scroll-snap]
sources:
