...
modified: 2026-08-28
definition: >-
  An action reachable only by an input the reader has to guess: a swipe, a long press, a
  two-finger tap, with nothing on screen saying it is there.
aliases:
...
tags: [perception]
relations:
  contrastWith: [signifier, easter-egg]
  variantOf: []
  partOf: []
  seeAlso: [long-press, swipe-actions, coach-mark]
implementations:
  - system: hig
    name: Gestures
