...
modified: 2026-08-26
definition: >-
  The one line a mail is opened or ignored on, written to survive a list that truncates it
  and shows it wedged between the sender and the preview text.
aliases:
  - name: subject
    source: community
  - name: email subject
...
relations:
  contrastWith: [preview-text, sender-name]
  seeAlso: [truncation]
implementations: []
sources:
