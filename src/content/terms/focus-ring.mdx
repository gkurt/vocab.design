...
status: published
definition: >-
  The visible outline drawn around the element that currently holds keyboard
  focus, showing where the next keypress will land.
aliases:
  - name: focus outline
  ...
  - name: keyboard focus indicator
    source: aria-apg
relations:
  contrastWith: [focus-visible, focus-appearance]
  seeAlso: [state-layer]
implementations:
  - system: polaris
