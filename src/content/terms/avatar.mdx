...
modified: 2026-08-26
definition: >-
  A small image standing in for a person or entity, falling back to initials or a
  generic glyph when there is no picture.
aliases:
  - name: persona
    source: fluent
...
tags: [messaging]
relations:
  contrastWith: [thumbnail, identicon]
  seeAlso: [avatar-group, image-well, presence-indicator, media-object, sender-name]
implementations:
  - system: fluent
    name: Avatar
