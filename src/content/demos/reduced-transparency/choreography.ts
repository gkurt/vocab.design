 ...
 * the preference asks for, drops the request so the frosted finish comes back and the read-outs
 * report the backdrop bleeding through, then honours it again and ends where it began. Each
...
export default steps([
  ...
  { assert: { selector: '[data-part=samples][data-setting=honoured]', state: 'visible' } },
  { wait: 800 },
  ...
  { assert: { selector: '[data-part=ratio][data-setting=ignored]', state: 'visible' } },
