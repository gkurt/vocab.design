    ...
    <div class="sp-app">
      <div class="sp-frame sp-frame--wide" style="width: 476px; height: 274px">
        <div class="sp-topbar sp-context">
          ...
          <sp-segmented class="sp-segmented" data-part="mode" data-value="tricked" style="flex: 0 0 auto">
            <button class="sp-segment" data-part="mode-tricked" type="button" value="tricked" style="padding: 4px 9px; font-size: 12px">As written</button>
            <button class="sp-segment" data-part="mode-plain" type="button" value="plain" style="padding: 4px 9px; font-size: 12px">Made plain</button>
          </sp-segmented>
        </div>
