...
export default steps([
  ...
  { assert: { selector: '[data-part=readout][data-running="1"]', state: 'visible' } },
  ...
  { assert: { selector: '[data-part=readout][data-running="2"]', state: 'visible' } },
  ...
  { assert: { selector: '[data-part=readout][data-running="3"]', state: 'visible' } },
