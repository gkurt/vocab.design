...
export default steps([
  ...
  { click: true },
  { wait: 700 },
  { assert: { selector: '[data-part=seg-8][data-selected]', state: 'visible' } },
  ...
  { click: true },
  { wait: 700 },
  { assert: { selector: '[data-part=seg-12][data-selected]', state: 'visible' } },
  ...
  { click: true },
  { wait: 700 },
  { assert: { selector: '[data-part=seg-4][data-selected]', state: 'visible' } },
  { assert: { selector: '[data-part=week][data-codes="4"]', state: 'visible' } },
  { wait: 800 },
]);
