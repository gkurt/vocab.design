    ...
    <div class="sp-app" style="gap: 10px">
      <div class="sp-frame sp-frame--wide" style="width: 476px; height: 262px">
        <div class="sp-topbar sp-context" style="padding: 6px 12px">
          ...
          <sp-segmented class="sp-segmented" data-part="lengths" data-value="short">
            ${LENGTHS.map(
              (length) => `
      ...
      <span class="sp-text sp-context" data-part="note" role="status" style="height: 32px; width: 452px; font-size: 12px; line-height: 16px; text-align: center"></span>
    </div>
  `;
