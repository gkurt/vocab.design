    ...
    <div class="sp-app" style="gap: 10px">
      <div class="sp-frame sp-frame--wide" style="width: 476px; height: 252px">
        <div class="sp-topbar sp-context" style="padding: 6px 12px">
          ...
          <sp-segmented class="sp-segmented" data-part="rhythms" data-value="four">
            ${RHYTHMS.map(
              (rhythm) => `
      ...
      <span class="sp-text sp-context" data-part="note" role="status" style="width: 452px; height: 16px; font-size: 12px; line-height: 16px; text-align: center">${NOTES.four}</span>
    </div>
  `;
