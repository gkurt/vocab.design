...
export default steps([
  ...
  { click: true },
  { wait: 800 },
  { assert: { selector: '[data-part=seg-three][data-selected]', state: 'visible' } },
  ...
  { click: true },
  { wait: 800 },
  { assert: { selector: '[data-part=seg-fitted][data-selected]', state: 'visible' } },
  ...
  { click: true },
  { wait: 800 },
  { assert: { selector: '[data-part=seg-two][data-selected]', state: 'visible' } },
  { assert: { selector: '[data-part=block]', state: 'visible' } },
  { wait: 900 },
]);
