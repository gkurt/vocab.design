    ...
    <div class="sp-app">
      <div class="sp-window" style="width: 420px">
        <div class="sp-row sp-row--between sp-context" style="justify-content: flex-end">
          <sp-segmented data-stage-mode class="sp-segmented" data-axis="Neutral at" data-term="zero" data-part="segmented" data-value="${START}">
        ...
        <p class="sp-text sp-context" data-stage-verdict data-part="note" data-centre="${START}"
