...
export default steps([
  ...
  { wait: 900 },
  { moveTo: '[data-part=mica-titlebar]' },
  { wait: 700 },
  { moveTo: '[data-part=seg-inactive]' },
  { click: true },
  { wait: 700 },
  { assert: { selector: '[data-part=mica][data-focus="inactive"]', state: 'visible' } },
  { assert: { selector: '[data-part=seg-inactive][aria-selected="true"]', state: 'visible' } },
  { wait: 1500 },
  { moveTo: '[data-part=seg-active]' },
  { click: true },
  { wait: 700 },
  { assert: { selector: '[data-part=mica][data-focus="active"]', state: 'visible' } },
  { assert: { selector: '[data-part=seg-active][aria-selected="true"]', state: 'visible' } },
  { wait: 900 },
]);
