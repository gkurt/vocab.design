...
// the legend that prints each product. The last pair reads the field and the overlap once more,
// which is what the deleted caption's assert used to stand in for. The opening wait is the kit's mount fade.
