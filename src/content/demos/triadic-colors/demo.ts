    ...
    <div class="sp-app">
      <div class="sp-window" style="width: 444px; padding: 13px 20px">
        <div class="sp-row sp-row--between sp-context" style="justify-content: flex-end">
          <sp-segmented data-stage-mode class="sp-segmented" data-part="segmented" data-axis="Scheme" data-term="triadic" data-value="${START}">
        ...
        <p class="sp-text sp-context" data-stage-verdict data-part="note" style="margin: 9px 0 0; height: 30px; font-size: 10.5px; line-height: 1.35">${start.note}</p>
      </div>
    </div>
  `;
