...
export default steps([
  ...
  { assert: { selector: '[data-part=last][data-how=drag]', state: 'visible' } },
  { wait: 900 },
  ...
  { wait: 600 },
  { assert: { selector: '[data-part=card-a][data-col=todo]', state: 'visible' } },
  { assert: { selector: '[data-part=last][data-how=menu]', state: 'visible' } },
  ...
  { click: true },
  { wait: 600 },
  { assert: { selector: '[data-part=offers][data-mode=drag]', state: 'visible' } },
