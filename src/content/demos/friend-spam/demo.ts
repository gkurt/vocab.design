    ...
    <div class="sp-app">
      <div class="sp-frame sp-frame--wide" style="width: 476px; height: 268px">
        <div class="sp-topbar sp-context" style="padding: 7px 12px">
          ...
          <sp-segmented class="sp-segmented" data-part="mode" data-value="vague" style="flex: 0 0 auto">
            <button class="sp-segment" data-part="mode-vague" type="button" value="vague" style="padding: 4px 9px; font-size: 11.5px">As asked</button>
            <button class="sp-segment" data-part="mode-exact" type="button" value="exact" style="padding: 4px 9px; font-size: 11.5px">Asked exactly</button>
          </sp-segmented>
        </div>
