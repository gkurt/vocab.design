...
export default steps([
  ...
  { assert: { selector: '[data-part=seg-warm][aria-selected="true"]', state: 'visible' } },
  { moveTo: '[data-part=seg-cool]' },
  { click: true },
  { wait: 500 },
  { assert: { selector: '[data-part=panel][data-temp="cool"]', state: 'visible' } },
  { assert: { selector: '[data-part=seg-cool][aria-selected="true"]', state: 'visible' } },
  { wait: 1300 },
  { moveTo: '[data-part=seg-neutral]' },
  { click: true },
  { wait: 500 },
  { assert: { selector: '[data-part=panel][data-temp="neutral"]', state: 'visible' } },
  { assert: { selector: '[data-part=seg-neutral][aria-selected="true"]', state: 'visible' } },
  { wait: 1300 },
