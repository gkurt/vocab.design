  ...
  root.innerHTML = `
    <div class="sp-app">
      ...
      <div class="sp-row sp-context" style="gap: 14px">
        ...
        <sp-segmented class="sp-segmented" data-part="route" data-value="obstructed">
          ...
          <button class="sp-segment" data-part="route-direct" type="button" value="direct" style="padding: 4px 10px; font-size: 12px">One click</button>
        </sp-segmented>
      </div>
    </div>
  `;
