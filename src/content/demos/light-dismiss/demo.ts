 ...
 *
 * The share buttons state inline-flex themselves: `.sp-icon` is display block,
 * and a bare icon inside a non-flex button breaks its label onto a second line.
 */
      ...
      <div class="sp-frame" style="height: 240px">
        ...
        <div class="sp-popover" data-part="popover" data-subject role="dialog" aria-label="Share" style="top: 46px; right: 12px; width: 190px; --sp-arrow-x: 150px">
          ...
          <div class="sp-stack" style="margin-top: 10px">
            <button class="sp-button sp-button--ghost sp-button--sm" type="button" style="display: inline-flex; align-items: center; justify-content: center; gap: 6px">${icon('copy')} Copy link</button>
            <button class="sp-button sp-button--ghost sp-button--sm" type="button" style="display: inline-flex; align-items: center; justify-content: center; gap: 6px">${icon('share')} Send by email</button>
          </div>
        </div>
      </div>
    </div>
