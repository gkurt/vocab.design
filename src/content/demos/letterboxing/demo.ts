      ...
      <div class="sp-frame sp-frame--wide" style="width: 476px; height: 300px">
        ...
        <div class="sp-body" style="display: flex; align-items: flex-start; gap: 14px; padding: 10px 12px">
          ...
          <div class="sp-stack sp-context" style="flex: 1 1 auto; min-width: 0; gap: 4px">
            <span class="sp-label">Source shape</span>
            <sp-segmented class="sp-segmented" data-part="aspects" data-value="16-9" style="align-self: flex-start">
              ${segment('16-9', '16:9')}${segment('4-3', '4:3')}${segment('9-16', '9:16')}
            </sp-segmented>
            <span class="sp-label" style="margin-top: 8px">Fit</span>
            <sp-segmented class="sp-segmented" data-part="fits" data-value="contain" style="align-self: flex-start">
