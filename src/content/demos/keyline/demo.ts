...
export function mount(root: HTMLElement): void {
  ...
  root.innerHTML = `
    <div class="sp-app" style="gap: 10px">
      ...
      <span class="sp-text sp-context" data-stage-verdict data-part="note" role="status" style="width: 452px; height: 16px; font-size: 12px; line-height: 16px; text-align: center">${NOTES.on}</span>
    </div>
  `;
