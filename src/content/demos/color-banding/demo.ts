 ...
 * register, along with the picker and the two panel labels (SPEC §5). The left label counted
 * the levels out ("Quantised to 6"), which the strip's own Levels switch already says, so it
 * now just names its panel against "As authored".
 *
    ...
    <div class="sp-app">
      <div class="sp-window" style="width: 438px; padding: 13px 18px">
        <div class="sp-row sp-row--between sp-context" style="justify-content: flex-end">
          <sp-segmented data-stage-mode class="sp-segmented" data-part="segmented" data-axis="Levels" data-value="${START}">
