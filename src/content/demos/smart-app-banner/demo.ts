...
export function mount(root: HTMLElement): void {
  ...
  root.innerHTML = `
    <div class="sp-app">
      <div class="sp-row sp-row--between sp-context" style="width: 452px; flex: 0 0 auto">
        <span class="sp-label" style="flex: 0 0 auto">Banner style</span>
        <sp-segmented class="sp-segmented" data-part="mode" data-value="strip" style="flex: 0 0 auto">
