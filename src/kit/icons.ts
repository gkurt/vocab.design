...
const PATHS = {
  ...
  eyeOff:
    '<path d="M4 4 20 20"/><path d="M9.7 5.3A9.4 9.4 0 0 1 12 6c5.6 0 9 6 9 6a15.6 15.6 0 0 1-3.4 3.9"/><path d="M6.5 7.9C4.2 9.5 3 12 3 12s3.4 6 9 6a9.4 9.4 0 0 0 3.4-.6"/><path d="M10.2 10.2a2.6 2.6 0 0 0 3.6 3.6"/>',
