function e(e,t,n){let r=n.length,i=i=>{let a=(i%r+r)%r,o=a*2*Math.PI/r-Math.PI/2,s=n[a];return[e+Math.cos(o)*s,t+Math.sin(o)*s]},a=e=>e.toFixed(1),o=i(0),s=`M${a(o[0])} ${a(o[1])}`;for(let e=0;e<r;e++){let t=i(e-1),n=i(e),r=i(e+1),o=i(e+2),c=3/16;s+=`C${a(n[0]+(r[0]-t[0])*c)} ${a(n[1]+(r[1]-t[1])*c)}`,s+=` ${a(r[0]-(o[0]-n[0])*c)} ${a(r[1]-(o[1]-n[1])*c)}`,s+=` ${a(r[0])} ${a(r[1])}`}return`${s}Z`}var t=e(100,98,[90,86,88,80,74,70,76,84]);function n(e){e.innerHTML=`
    <div class="sp-app" data-loop="keep" style="gap: 9px">
      <div class="sp-frame sp-frame--wide" style="width: 476px; height: 252px">
        ...
        <div class="sp-body" style="display: flex; align-items: center; gap: 14px; padding: 14px 16px; background: var(--sp-surface)">
          ...
          >
            <defs>
              <clipPath id="h3-clip"><path d="${t}" /></clipPath>
            ...
            <g data-part="object" data-subject>
              ...
              <path d="${t}" fill="none" stroke="url(#h3-rim)" stroke-width="3" />
