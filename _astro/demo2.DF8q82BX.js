var e=`rgb(0 0 0 / 0.34)`,t=`repeating-linear-gradient(180deg, #fdfdfe 0 2px, #e2e5ea 2px 3px)`,n=`linear-gradient(180deg, rgb(255 255 255 / 0.9), rgb(255 255 255 / 0) 58%, rgb(0 0 0 / 0.08))`;function r(e,t){return`<span style="width: 12px; height: 12px; border-radius: 50%; background: radial-gradient(circle at 34% 26%, rgb(255 255 255 / 0.95) 0 12%, ${e} 46%, ${t} 100%); border: 1px solid rgb(0 0 0 / 0.28); box-shadow: inset 0 -2px 3px rgb(0 0 0 / 0.2)"></span>`}function i(t,n,r,i){return[`background-color: ${t}`,`background-image: linear-gradient(180deg, rgb(255 255 255 / 0.92) 0, rgb(255 255 255 / 0.34) 44%, rgb(255 255 255 / 0.02) 46%, ${n} 100%)`,`border: 1px solid ${e}`,`border-radius: 999px`,`box-shadow: inset 0 -5px 7px rgb(255 255 255 / 0.3), 0 1px 2px rgb(16 24 40 / 0.32)`,`color: ${r}`,`text-shadow: ${i}`,`padding: 4px 16px 5px`,`font-size: 12px`,`font-weight: 600`,`cursor: pointer`].join(`; `)}function a(a){a.innerHTML=`
    <div class="sp-app" style="gap: 10px">
      <div data-part="window" data-subject
           style="width: 306px; border-radius: 9px; overflow: hidden; border: 1px solid ${e};
        ...
        <div data-part="titlebar"
             style="display: flex; align-items: center; gap: 8px; height: 26px; padding: 0 9px;
                    background-image: ${n}, ${t}; border-bottom: 1px solid #a6acb5">
          <span data-part="lights" aria-hidden="true" style="display: flex; gap: 5px">
            ${r(`#ff6f61`,`#c8392c`)}${r(`#ffce55`,`#c99512`)}${r(`#6fce4b`,`#3d8f24`)}
          </span>
        ...
        <div style="display: flex; background-image: repeating-linear-gradient(180deg, #fbfcff 0 3px, #e6edfb 3px 4px)">
          <div data-part="pinstripes" style="flex: 1 1 auto; min-width: 0; padding: 12px 12px 10px">
            ...
            <div style="display: flex; align-items: center; gap: 7px; margin-top: 9px">
              <span aria-hidden="true"
                    style="width: 13px; height: 13px; border-radius: 3px; border: 1px solid ${e};
          ...
          <div data-part="scrollbar" aria-hidden="true"
            ...
            <span style="display: block; height: 52px; border-radius: 999px; border: 1px solid ${e};
        ...
        <div style="display: flex; align-items: center; justify-content: flex-end; gap: 9px; padding: 9px 12px;
                    background-image: ${n}, ${t}; border-top: 1px solid #b7bcc4">
          <button data-part="gel-cancel" type="button"
                  style="${i(`#e4e7ec`,`rgb(150 160 175 / 0.5)`,`#2b323b`,`0 1px 0 rgb(255 255 255 / 0.8)`)}">Cancel</button>
          <span data-part="gel-default"
            ...
            <button data-part="gel-default-button" type="button"
                    style="${i(`#2f7fe8`,`rgb(120 180 255 / 0.62)`,`#ffffff`,`0 -1px 0 rgb(0 0 0 / 0.32)`)}">Save</button>
          </span>
        </div>
      </div>
