var e=`linear-gradient(140deg, #f6f4f2, #d9d5d2 46%, #a9a5a4)`;function t(t){t.innerHTML=`
    <div class="sp-app">
      <div data-part="card" data-subject
        ...
        <div data-part="scene"
          ...
          <span data-part="sun" aria-hidden="true"
                style="position: absolute; left: 50%; top: 24px; width: 104px; height: 104px; margin-left: -52px; border-radius: 50%; background-image: linear-gradient(180deg, #fff3bc 6%, #ffb066 46%, #ff5fa8); overflow: hidden">${[58,68,78,88].map(e=>`<span style="position: absolute; left: -2px; right: -2px; top: ${e}px; height: 5px; background: rgb(90 30 122 / 0.85)"></span>`).join(``)}</span>

          <span data-part="grid" aria-hidden="true"
                style="position: absolute; left: -60%; right: -60%; bottom: -18px; height: 128px; background-image: repeating-linear-gradient(90deg, rgb(126 249 255 / 0.8) 0 1px, transparent 1px 30px), repeating-linear-gradient(0deg, rgb(255 106 213 / 0.75) 0 1px, transparent 1px 20px); transform: perspective(140px) rotateX(66deg); transform-origin: bottom center"></span>

          <span data-part="bust" aria-hidden="true" style="position: absolute; left: 26px; bottom: 12px; width: 62px; height: 104px">
            <span style="position: absolute; left: 12px; bottom: 78px; width: 34px; height: 42px; border-radius: 50% 50% 46% 46%; background-image: ${e}"></span>
            <span style="position: absolute; left: 24px; bottom: 68px; width: 12px; height: 14px; background-image: ${e}"></span>
            <span style="position: absolute; left: 4px; bottom: 34px; width: 54px; height: 38px; border-radius: 26px 26px 5px 5px; background-image: ${e}"></span>
          ...
          <div data-part="wordmark"
               style="position: absolute; left: 0; right: 0; bottom: 34px; text-align: center; font-family: Georgia, 'Times New Roman', serif; font-size: 34px; font-weight: 700; letter-spacing: 0.02em; line-height: 1; background-image: linear-gradient(180deg, #ffffff 6%, #a8f5ff 30%, #2b2a6e 50%, #ffd9f4 58%, #ff74d2 78%, #ffffff); -webkit-background-clip: text; background-clip: text; color: transparent; -webkit-text-stroke: 0.7px rgb(58 12 74 / 0.92)">
            V A P O R
          </div>
        </div>
      </div>
