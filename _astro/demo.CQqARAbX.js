import{n as e}from"./parts.C-YLuC7Q.js";function t(t){t.innerHTML=`
    <div class="sp-app" style="padding: 0">
      ...
      <div data-part="card" data-subject
        ...
        <div data-part="wordmark" style="position: relative; font-size: 30px; font-weight: 900; letter-spacing: -0.02em; line-height: 1.05; background-image: linear-gradient(180deg, #f7fbff 6%, #9fc4e8 34%, #2f5f9c 50%, #dfeeff 58%, #7fa6cf 78%, #eaf4ff); -webkit-background-clip: text; background-clip: text; color: transparent; -webkit-text-stroke: 0.7px rgb(18 44 84 / 0.9)">
          PORTAL
        </div>
  ...
  `;let n=e(t,`enter`),r=e(t,`status`);n.addEventListener(`click`,()=>{n.style.backgroundImage=`linear-gradient(180deg, #3d80c6, #8fc6f2 52%, #ffffff)`,n.style.boxShadow=`inset 0 2px 5px rgb(16 58 116 / 0.5)`,r.style.opacity=`1`})}export{t as mount};